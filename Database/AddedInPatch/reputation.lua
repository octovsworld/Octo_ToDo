...
----------------------------------------------------------------
E.OctoTable_AddedInPatch_reputation = {
	[2796] = {
...
for reputationID, data in next, (E.OctoTable_AddedInPatch_reputation) do
...
-- local itemCache = E.OctoTable_AddedInPatch_reputation[id].itemCache
-- local paragonQuest = E.OctoTable_AddedInPatch_reputation[id].paragonQuest
